...
import com.example.ellilim.drawinggameproject.mCaptureFragments.GameResultFragment;
...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback,GoogleMap.OnMarkerClickListener,View.OnClickListener,GoogleMap.OnMapClickListener{
            ...
            if (ContextCompat.checkSelfPermission(this, Manifest.permission.ACCESS_FINE_LOCATION) == PackageManager.PERMISSION_GRANTED) {
                ...
                if (ContextCompat.checkSelfPermission(this, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
                    if (ActivityCompat.shouldShowRequestPermissionRationale(this, Manifest.permission.ACCESS_FINE_LOCATION)) {
                        //Create AlertDialog to show the message for the location permission
    ...
    //Put on debugmode and stop the automatic location updates.
    ...
    //Allow user to change location of radius
